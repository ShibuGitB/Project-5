...
def app23() : 
    ...
    st.title("Category : Comedy"":performing_arts:")
    st.video("Category Videos/Comedy.mp4") 
    st.text("Chattambi Naadu - Damu Comedy Scenes") 
    ...
    try : 
        ...
        st.caption("Put Your Review there , for the Rating :writing_hand:") 